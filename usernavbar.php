...
<body id="background" class="background">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <a class="nav-link active text-primary" aria-current="page" href="signed_in.php">Home</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-primary" href="user_create_posts.php">Create Post</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-primary" href="view_posts.php">View Your Posts</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-primary" href="user_all_posts.php">View All Posts</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-primary" href="profile.php">Edit Profile</a>
    </li>
    <li class="nav-item">
