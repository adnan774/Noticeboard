    ...
    if(isset($_POST['title'])) 
    {
        ...
        }else 
        {
            ...
            if ($result)
            {
                ...
                $message = "Hi $username, you have successfully set your post, please <a class='btn btn-primary' data-bs-toggle='collapse' role='button' href='all_posts.php'>View Posts</a><br>";
            } else
            {
