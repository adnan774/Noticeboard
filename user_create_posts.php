...
if(!$is_update)
{
    ...
    if(isset($_POST['title'])) 
    {
        ...
        {
            //create new post
            $query = "INSERT INTO posts (uid, title, created, content, image) VALUES ('$userid', '$title', '$created', '$content', '$image')";
            ...
            if ($result)
            {
                // show a successful set post message: 
                $message = "Hi $username, you have successfully set your post, please <a a class='btn btn-primary' data-bs-toggle='collapse' role='button' href='all_posts.php'>View Posts</a><br>";
            } else
            {
