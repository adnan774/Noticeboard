...
if ($show_profile_form)
{
    ...
    if ($n > 0)
    {
        ...
        echo <<<PROFILE
        <form class="form" id="profile" action="profile.php" method="POST">
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="container1">
                        ...
                        <input type="text" minlength="1" maxlength="32" placeholder="Enter County" value="{$row['city']}" name="city" required>
