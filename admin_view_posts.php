...
_END;
        echo '<form action="admin_view_posts.php" method="POST">
        ...
        echo '<tr><th>Title</th><th>Created</th><th>Content</th><th>Image</th><th>Edit</th><th>Delete</th></tr>';
        ...
        for ($i=0; $i<$n; $i++)
        {
            ...
            echo '<tr>';
            echo '<td>'.$row['title'].'</td><td>'.$row['created'].'</td><td>'.$row['content'].'</td><td><img alt="'.$row['image'].'" src="'.$row['image'].'"></td><td><form action="admin_update_post.php" method="POST"><button type="submit" class="signButton" name="pid" value="'.$row['postid'].'">Edit</button></form></td><td><form action="admin_delete_posts.php" method="POST"><button type="submit" class="signButton" name="pid" value="'.$row['postid'].'">Delete</button></form></td>';
            echo "</tr>";
        }
        echo "</table>";
