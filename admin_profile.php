...
if ($show_profile_form)
{
    ...
    $query = "SELECT username, password, firstname, lastname, email, age, city, county, country, phone FROM users WHERE uid = '{$_SESSION['uid']}'";
    ...
    if ($n > 0)
    {
        ...
        echo <<<PROFILE
        <form class="form" id="profile" action="admin_profile.php" method="POST">
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="container1">
                        ...
                        <input type="text" minlength="1" maxlength="32" placeholder="Enter Country" value="{$row['city']}" name="city" required>
